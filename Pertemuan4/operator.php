...
$KursiTotal = 45;
$KursiTerisi = 28;
$jumlahKursiKosong = $KursiTotal - $KursiTerisi;
$persentaseKursiKosong = ($jumlahKursiKosong / $KursiTotal) * 100;

echo "SOAL CERITA <br>";
echo "Jumlah kursi kosong di restoran: " . $jumlahKursiKosong . "<br>";
echo "Persentase kursi kosong di restoran: " . number_format($persentaseKursiKosong, 2) . "%";
